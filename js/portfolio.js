const PORTFOLIO_TEXT = {
  hu: {
    ...
    heroCopy: "Portrék, páros sorozatok, baba-, autós- és kreatív fotók Bécsből és környékéről, valódi fényekkel és túlstilizálás nélkül.",
    allLabel: "Összes kategória",
    totalLabel: "Válogatott képek",
    ctaTitle: "Ha ezt a világot szeretnéd a saját képeidhez is, itt kezdjük.",
    ctaCopy: "A fotózás nem sabloncsomag. Először megbeszéljük, mire van szükséged, utána találunk időpontot, helyszínt és megfelelő csomagot.",
    ctaButton: "Időpontot szeretnék",
    open: "Megnyitás",
  ...
  de: {
    ...
    heroCopy: "Porträts, Paare, Baby-, Auto- und kreative Serien aus Wien und Umgebung mit echtem Licht, klarer Stimmung und ohne künstlichen Überstil.",
    allLabel: "Alle Kategorien",
    totalLabel: "Kuratiertes Bildmaterial",
    ctaTitle: "Wenn du genau diese Bildwelt für deine eigenen Fotos willst, geht es hier weiter.",
    ctaCopy: "Das Shooting ist kein Standardslot. Wir klären zuerst Ziel, Stimmung und Ort und legen dann das passende Paket fest.",
